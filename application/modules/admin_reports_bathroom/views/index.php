            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa icon-notebook"></i> Report Cleaning Bathroom
                    </div>
                    <div class="card-body">
                    <?php echo form_open('index.php/administrator/reportCleaningBathroom/searchDataReporting',array("class"=>"form-horizontal")); ?>
                    ...
                    <div class="pull-left">
                        <div>
                            <i class="fa fa-align-justify"></i> List Clean Bathroom
                        &nbsp;
                        <a href="<?php echo site_url('index.php/administrator/reportCleaningBathroom/index'); ?>" 
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>  
                                ...
                                <td><?php  echo $dataReporting['SABUN']; ?></td>
                                <td><?php  echo $dataReporting['TOILET']; ?></td>
                                <td><?php  echo $dataReporting['DINDING']; ?></td>
                                <td><?php  echo $dataReporting['TEMPAT_SAMPAH']; ?></td>

                                <td><?php  echo $dataReporting['AROMA']; ?></td>
                                <td><?php  echo $dataReporting['KAIN']; ?></td>
                                <td><?php  echo $dataReporting['PINTU']; ?></td>
                                <td><?php  echo $dataReporting['KRAN']; ?></td>
