        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <?php echo form_open('index.php/administrator/reportCleaningBuilding/searchDataReporting',array("class"=>"form-horizontal")); ?>
                    ...
                    <div class="pull-left">
                        ...
                        &nbsp;
                        <a href="<?php echo site_url('index.php/administrator/reportCleaningBuilding/index'); ?>" 
