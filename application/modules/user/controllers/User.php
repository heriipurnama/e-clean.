...
class User extends MX_Controller{
    ...
    {   
        ...
        $resultDescGroup = $this->User_model->listGropDesc();
		...
		if($this->form_validation->run())     
        {
            ...
            $user_id = $this->User_model->add_G_USERS($params); 
        ...
        { 
            $data['content'] = $this->load->view('user/add',null,true);
            $this->parser->parse(TEMPLATE.'/content_admin', $data);
        }
    }  
    ...
    function remove($id)
    {
        ...
        $user = $this->User_model->get_G_USERS($id);

        // check if the user exists before trying to delete it
        if(isset($user['U_ID']))
        {
            $this->User_model->delete_G_USERS($id);
