...
class UserBathroomModel extends CI_Model
{
     ...
     */
    function add_dt_bathrooms ( $params )
    {
        $sql = " INSERT INTO dt_bathrooms ( AREA_ID, TANGGAL, TIME,
         TOILET, SABUN, LANTAI, DINDING, AROMA, KAIN, PINTU, KRAN, TEMPAT_SAMPAH, 
         CATATAN, CREATED_BY, CREATED_DATE ) 
        VALUES ('$params[AREA_ID]', '$params[TANGGAL]', '$params[TIME]',
        '$params[TOILET]', '$params[SABUN]', '$params[LANTAI]', '$params[DINDING]', '$params[AROMA]', '$params[KAIN]', '$params[PINTU]', '$params[KRAN]', '$params[TEMPAT_SAMPAH]', 
        '$params[CATATAN]', '$params[CREATED_BY]', '$params[CREATED_DATE]') ";
