            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Add Menu
                    </div>
                    <div class="card-body">
                        <?php echo form_open('menu/add',array("class"=>"form-horizontal")); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    echo form_dropdown('menu_type',$options,$this->input->post('menu_type'),'id="menu_type" class="form-control" style="width: 100%" onchange="change_type(this.value)"');?>
                            ...
                            <div class="form-group" id="block_cms">
                                ...
                                <div class="col-md-8">
                                    ...
                                    echo form_dropdown('cms_id',$options,$this->input->post('cms_id'),'id="cms_id" class="form-control" style="width: 100%"');?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="number" name="ordering" value="<?php echo $this->input->post('ordering'); ?>" class="form-control" id="ordering" />
