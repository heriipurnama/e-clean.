...
class User_buildings extends MX_Controller{
    function __construct()
    {
        parent::__construct();
        $this->sess_id = $this->session->userdata('userid');
        $this->load->model('UserBuildingModel');
    } 
    ...
    function index(){
      ...
      //  $data['content'] = $this->load->view('user_warehouse/index',$data,true);  
     ...
     //   $params['limit'] = RECORDS_PER_PAGE; 
      ...
      //  $config = $this->config->item('pagination');
       // $config['base_url'] = site_url('index.php/user_warehouse/index');
       // $config['total_rows'] = $this->EmployeUserWareHouseModele_model->get_all_komentar_count();
        // $this->pagination->initialize($config);

        // $data['publikasi'] = $this->Employee_model->get_all_komentar($params);
        
         $data['content'] = $this->load->view('user_buildings/index',$data,true);
      //  $data['content'] = $this->load->view('user_warehouse/index');
        $this->parser->parse(TEMPLATE.'/content', $data);
    }
    

     /*
     * Adding a new report buildings
     */
    function add()
    {   
        if(empty($this->sess_id)) {
        ...
        $params = array(
            ...
            'SARANG_LABA_LABA'=> strval($this->input->post("spider")),
            'KACA'=> strval($this->input->post("glass")),
            'BESI_UWF'=> strval($this->input->post("iron")),
            ...
            $user_id = $this->UserBuildingModel->add_dt_buildings( $params ); 
            ...
            redirect('index.php/user/building');
        }
        else
        { 

        $data['content'] = $this->load->view('user_buildings/index', null, true);
        $this->parser->parse(TEMPLATE.'/content', $data);
        }
    }  
