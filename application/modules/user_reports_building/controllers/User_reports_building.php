...
class User_reports_building extends MX_Controller {
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('index.php/user_reports_building/index');
        ...
        $data['content'] = $this->load->view('user_reports_building/index',$data,true);
    ...
    public function searchDataReporting()
    {
        ...
        $config = $this->config->item('pagination');
        $config['base_url'] = site_url('index.php/user_reports_building/searchSPL');
